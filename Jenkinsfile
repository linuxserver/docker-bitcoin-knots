pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'BITCOIN_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-bitcoin-knots'
    CONTAINER_NAME = 'bitcoin-knots'
    DOCKERHUB_IMAGE = 'linuxserver/bitcoin-knots'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/bitcoin-knots'
    PR_DOCKERHUB_IMAGE = 'lspipepr/bitcoin-knots'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-bitcoin-knots/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-bitcoin-knots\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-bitcoin-knots\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Bitcoin-knots\" \
          --label \"org.opencontainers.image.description=[Bitcoin Knots](https://bitcoinknots.org/) can be used as a desktop client for regular payments or as a full node server utility for merchants and other payment services.\" \
